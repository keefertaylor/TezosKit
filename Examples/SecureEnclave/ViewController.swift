...
///          Read more: https://medium.com/@keefertaylor/signing-tezos-transactions-with-ioss-secure-enclave-and-face-id-6166a752519
class ViewController: UIViewController {
  /// UI Components.
  public let warningLabel: UILabel = UILabel()
  ...
  override func viewDidAppear(_ animated: Bool) {
    ...
    let warningMessage = """
      Key management in the secure enclave is non-trivial.\n\n

      Incorrect usage can lead to irrecoverable loss of funds.\n\n

      Please read documentation in:\n
      - SecureEnclaveWallet.swift\n
      - https://medium.com/@keefertaylor/signing-tezos-transactions-with-ioss-secure-enclave-and-face-id-6166a752519 \n\n

      BEFORE storing funds in an address generated by the Secure Enclave.
    """

    showAlert(title: "Warning", message: warningMessage)
  }
